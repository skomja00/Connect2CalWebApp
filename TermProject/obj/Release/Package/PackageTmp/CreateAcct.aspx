<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateAcct.aspx.cs" Inherits="TermProject.CreateAcct" %>
...
<body class="d-flex align-items-center justify-content-center mt-md-5">
    <form id="form1" runat="server">
        ...
        <%--Start Create Account Card--%>
            <div id="createAcctCard" class="card" runat="server">
                <div class="card-body">
                    <div class="container">
                        <div class="row justify-content-center mb-1">
                            <div class="col-md-6 mb-1">
                                <img src="Images/calendar.svg" class="imgAvatarW8"/>
                                &nbsp;
                                <asp:Label ID="lblTopMessage" CssClass="h4" runat="server" Text="Enter your account information."></asp:Label>
                            </div>
                        </div>
                        <div class="row mb-1">
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <asp:Image ID="imgAvatar" runat="server" ImageUrl="Images/Avatars/default-avatar.svg" CssClass="imgAvatarW10" />
